...
ice.forEach(cube =>{
    ...
    ice[0].style.transform=`translate(132px, 165px) rotate(20deg)`;

    ice[1].style.transform=`translate(8px, -4px)rotate(-10deg)`;

    ice[2].style.transform=`translate(8px, -3px)rotate(-122deg)`;

    ice[3].style.transform=`translate(126px, -36px)rotate(28deg)`;

    ice[4].style.transform=`translate(47px, -49px)rotate(-16deg)`;
